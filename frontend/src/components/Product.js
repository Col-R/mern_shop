  ...
  return (
    <div className = "product">
        ...
        <div className = "product__info">
            ...
            <p className = "info__description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus, vero? Tempore nemo libero dicta facilis!</p>
